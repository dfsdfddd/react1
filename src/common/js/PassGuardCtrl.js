...
export function passGuardInit(){
  ...
  // var licenseMac = process.env.LICENSEMAC;
	...
	//测试license授权
	var license = "";
	var licenseMac = "";
			 ...
			 if(window.isInstalled){
				 ...
				 for(var i = 0;i < pges.length;i++ ){
					...
					if(obj.osBrowser == 10){
						...
						document.querySelector("#" + id + "_down").parentNode.innerHTML = '<input placeholder="' + obj.settings.placeHoder + '" type="text" onfocus="'+ strr +'pgeCtrl.openProt(\''+winId+'\',this.id);pgeCtrl.setCX(this);'+obj.settings.pgeOnFocus+'"  onkeydown="pgeCtrl.setSX(event,\''+obj.settings.pgeOnKeyDown+'\',this);" onclick = "pgeCtrl.setCX(this)" onblur = "pgeCtrl.closeProt(\''+winId+'\',this.id);'+obj.settings.pgeOnBlur+'" id = "'+id+'" style="ime-mode:disabled" tabindex="2" class="' + obj.settings.pgeClass + '" onselectstart="return false;" unselectable="on" oncopy="return false" oncut="return false" />';
